...
setlocal formatoptions-=M formatoptions+=B formatoptions+=m

let b:undo_ftplugin = (exists('b:undo_ftplugin')? b:undo_ftplugin . '|': '')
      \ . "setlocal list< tabstop< shiftwidth< softtabstop< noexpandtab< textwidth< conceallevel< formatoptions<"
